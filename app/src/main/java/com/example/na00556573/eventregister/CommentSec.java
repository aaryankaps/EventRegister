...
public class CommentSec extends AppCompatActivity {
    FirebaseListAdapter<Comments> adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_comment_sec);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FirebaseDatabase.getInstance()
                        .getReference("Comments").child(getIntent().getStringExtra("eventTitle")) //put event name
                        .push()
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("Comments").child(getIntent().getStringExtra("eventTitle"));
